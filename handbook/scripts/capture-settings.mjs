...
const SHOTS = [
  ...
  { name: 'm-06-mode-edit',       tab: 'missions',  desc: { de: 'Modus bearbeiten: Regelwerk, Timer, Verfügbarkeit und das Aussehen der Modus-Kachel.', en: 'Edit mode: ruleset, timer, availability and how the mode tile looks.', fr: 'Modifier un mode : jeu de règles, minuteur, disponibilité et apparence de la tuile.', it: 'Modifica modalità: insieme regole, timer, disponibilità e aspetto del riquadro.', es: 'Editar modo: conjunto de reglas, temporizador, disponibilidad y aspecto del mosaico.' },
    setup: async (page) => { await page.evaluate(() => showEditMode(1)); await page.waitForTimeout(600); } },
